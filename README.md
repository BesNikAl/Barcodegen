...
- [`main.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/main.py)
- [`BarcodeGen.spec`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/BarcodeGen.spec)
- [`build.bat`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/build.bat)
- [`requirements.txt`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/requirements.txt)
- **core/**
  - [`__init__.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/core/__init__.py)
  - [`csv_importer.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/core/csv_importer.py)
  - [`datamatrix_generator.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/core/datamatrix_generator.py)
  - [`history_manager.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/core/history_manager.py)
  - [`pdf_exporter.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/core/pdf_exporter.py)
  - [`settings.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/core/settings.py)
  - [`validator.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/core/validator.py)
- **docs/**
  - [`CHANGELOG.md`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/docs/CHANGELOG.md)
- **ui/**
  - [`main_window.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/ui/main_window.py)
  - [`__init__.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/ui/__init__.py)
  - **widgets/**
    - [`__init__.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/ui/widgets/__init__.py)
    - [`history_table.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/ui/widgets/history_table.py)
    - [`info_panel.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/ui/widgets/info_panel.py)
    - [`input_panel.py`](https://raw.githubusercontent.com/BesNikAl/Barcodegen/master/ui/widgets/input_panel.py)
